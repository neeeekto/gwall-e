...
| [structure.md](structure.md) | Раскладка `go.work`, состав модулей workspace (вкл. `inventory`) | При навигации по репозиторию | существует |
| [build.md](build.md) | Команды сборки/запуска/тестов/валидации (`go vet`, workspace-build) | Перед сборкой/прогоном тестов | существует |
